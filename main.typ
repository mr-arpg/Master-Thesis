...
#show: thesis.with(
  ...
  title: "The Plasma Way to Ammonia",

  subtitle: "Modelling and Understanding Plasma-Derived NH₃", // *
...
#include("Chapters/2-Theoretical-Background.typ")
#include("Chapters/3-Experimental-Measurements.typ")
#include("Chapters/4-Modelling-NH3-Plasmas.typ")
#include("Chapters/5-Tool-Development.typ")
